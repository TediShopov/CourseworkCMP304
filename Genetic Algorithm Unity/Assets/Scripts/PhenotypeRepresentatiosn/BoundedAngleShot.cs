...
public class BoundedAngleShot : MonoBehaviour, ShotPhenotypeRepresentation
{
    ...
    //    var dirToXMin = (Vector3.forward - new Vector3(_myBounds.min.x, _myBounds.min.y, _myBounds.min.z)).normalized;
    //    var dirToXMax = (Vector3.forward - new Vector3(_myBounds.max.x, _myBounds.max.y, _myBounds.max.z)).normalized;
